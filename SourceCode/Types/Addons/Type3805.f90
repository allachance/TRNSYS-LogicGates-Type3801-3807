Subroutine Type3805
   ...
   !    DESCRIPTION
   !------------------------------------------------------------------------------------
   ! Subroutine Type3805 implements a logical XOR gate in a TRNSYS simulation. It
   ! evaluates inputs and computes their XOR result based on the selected mode.
   !
   ! Parameters:
   ...
   !
   ! Outputs:
   !   Returns 1 if the number of true inputs is odd; otherwise returns 0.
   !
   ! Version History:
   !   2025-05-01 – A. Lachance: Original implementation.
   !
   ! Export this subroutine for use in external DLLs.
   !DEC$ATTRIBUTES DLLEXPORT :: TYPE3805
   !------------------------------------------------------------------------------------
   !    VARIABLES
   !------------------------------------------------------------------------------------
   Use TrnsysConstants
