Subroutine Type3803
   ...
   !    DESCRIPTION
   !------------------------------------------------------------------------------------
   ! Subroutine Type3803 implements a logical OR gate in a TRNSYS simulation. It
   ! evaluates inputs and computes their OR result based on the selected mode.
   !
   ! Parameters:
   ...
   !
   ! Outputs:
   !   Returns 1 if at least one input is true; otherwise returns 0.
   !
   ! Version History:
   !   2025-05-01 – A. Lachance: Original implementation.
   !
   ! Export this subroutine for use in external DLLs.
   !DEC$ATTRIBUTES DLLEXPORT :: TYPE3803
   !------------------------------------------------------------------------------------
   !    VARIABLES
   !------------------------------------------------------------------------------------
   Use TrnsysConstants
